...
app.get('/signupextra', passportConfig.isAuthenticated, userController.getSignupExtra);
app.post('/signupextra', passportConfig.isAuthenticated, userController.postSignupExtra);
...
app.delete('/treatment/patient', passportConfig.isAuthenticated, patientsController.getRemovePatient);
